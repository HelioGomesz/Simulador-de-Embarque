...
botaoLogin.addEventListener("click", function () {
  ...
  if (pegarUsuario === validarUsuario && pegarSenha === validarSenha) {
    //Verificar se os dados inseridos correspondem às credenciais padrão
    window.location.href = "../AppSimulador/SimuladorEmbarque.html"; //Função de redirecionar para página desejada
  } else {
